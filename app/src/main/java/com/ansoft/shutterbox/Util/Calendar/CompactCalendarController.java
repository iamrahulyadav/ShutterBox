package com.ansoft.shutterbox.Util.Calendar;
...
class CompactCalendarController {
    ...
    private int eventsDayTextColor;
    ...
    CompactCalendarController(Paint dayPaint, OverScroller scroller, Rect rect, AttributeSet attrs,
                              Context context, int currentDayBackgroundColor, int calenderTextColor, int currentSelectedDayBackgroundColor, int eventsDayTextColor) {
        this.dayPaint = dayPaint;
        this.scroller = scroller;
        this.rect = rect;
        this.currentDayBackgroundColor = currentDayBackgroundColor;
        this.calenderTextColor = calenderTextColor;
        this.eventsDayTextColor=eventsDayTextColor;
    ...
    private void loadAttributes(AttributeSet attrs, Context context) {
        if (attrs != null && context != null) {
            ...
            try {
                ...
                eventsDayTextColor=typedArray.getColor(R.styleable.CompactCalendarView_eventsDayTextColor, eventsDayTextColor);
    ...
    private void init(Context context) {
        ...
        eventsPaint.setColor(calenderBackgroundColor);
        eventsPaint.setTextAlign(Paint.Align.CENTER);
        eventsPaint.setTypeface(Typeface.SANS_SERIF);
        eventsPaint.setTextSize(textSize);
    ...
    void drawMonth(Canvas canvas, Calendar monthToDrawCalender, int offset) {
        ...
        List<CalendarDayEvent> uniqCalendarDayEvents =
                events.get(getKeyForCalendarEvent(monthToDrawCalender));
